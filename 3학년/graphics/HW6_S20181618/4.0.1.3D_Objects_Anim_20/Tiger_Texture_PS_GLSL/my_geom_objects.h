...
#define TEXTURE_ID_BIKE 5
#define TEXTURE_ID_FLOOR2 6
...
float t_stamp = 0.0f;
float rotation_algle_bus = 0.0f;
float spider_stamp = 0.0f;
int spider_flag = 0;
...
void prepare_floor(void) { // Draw coordinate axes.
	...
	My_glTexImage2D_from_file("Data/static_objects/jongang.jpg");
	...
	material_screen.ambient_color[0] = 1.0f;
	material_screen.ambient_color[1] = 1.0f;
	material_screen.ambient_color[2] = 1.0f;
	material_screen.ambient_color[3] = 1.0f;
									  
	material_screen.diffuse_color[0] = 1.0f;
	material_screen.diffuse_color[1] = 1.0f;
	material_screen.diffuse_color[2] = 1.0f;
	material_screen.diffuse_color[3] = 1.0f;
									
	material_screen.specular_color[0] =1.0f;
	material_screen.specular_color[1] =1.0f;
	material_screen.specular_color[2] =1.0f;
...
void prepare_bike(void) {
	...
	//material_bike.emissive_color[3] = 1.0f;
		...
		My_glTexImage2D_from_file("Data/static_objects/test.jpg");
		glGenerateMipmap(GL_TEXTURE_2D);
