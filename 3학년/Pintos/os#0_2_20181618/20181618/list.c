...
/*입력받은 두 element를 swap해주는 함수*/
void list_swap(struct list_elem *a, struct list_elem *b){
	struct list_elem *t1, *t2;
	t1 = (struct list_elem*)malloc(sizeof(struct list_elem));
	t2 = (struct list_elem*)malloc(sizeof(struct list_elem));
